...
var (
	...
	weaknesses = []*Weakness{
		...
		{
			ID: "22",
			Description: "The software uses external input to construct a pathname that is intended " +
				"to identify a file or directory that is located underneath a restricted parent directory, " +
				"but the software does not properly neutralize special elements within the pathname that " +
		...
		{
			ID: "310",
			Description: "Weaknesses in this category are related to the design and implementation of " +
				"data confidentiality and integrity. Frequently these deal with the use of encoding " +
				"techniques, encryption libraries, and hashing algorithms. The weaknesses in this " +
				"category could lead to a degradation of the quality data if they are not addressed.",
			Name: "Cryptographic Issues",
		},
		{
			ID: "322",
			Description: "The software performs a key exchange with an actor without verifying the " +
		...
		},
		{
			...
			Description: "The software stores or transmits sensitive data using an encryption scheme " +
				"that is theoretically sound, but is not strong enough for the level of protection required.",
		...
		{
			ID: "338",
			Description: "The product uses a Pseudo-Random Number Generator (PRNG) in a security context, " +
				"but the PRNG's algorithm is not cryptographically strong.",
			Name: "Use of Cryptographically Weak Pseudo-Random Number Generator (PRNG)",
		},
		{
			ID: "377",
			Description: "Creating and using insecure temporary files can leave application and system " +
				"data vulnerable to attack.",
			Name: "Insecure Temporary File",
		},
		{
			ID: "409",
			Description: "The software does not handle or incorrectly handles a compressed input with " +
				"a very high compression ratio that produces a large output.",
		...
		{
			ID: "798",
			Description: "The software contains hard-coded credentials, such as a password or " +
		...
		},
		{
			...
			Description: "The software constructs a string for a command to executed by a separate " +
				...
				"arguments, options, or switches within that command string.",
